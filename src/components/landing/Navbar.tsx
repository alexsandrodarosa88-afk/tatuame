    ...
    <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-xl bg-background/70 border-b border-border">
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        ...
        {user ? (
          ...
          <div className="flex items-center gap-2">
            <a href="https://instagram.com/tatuameoficial" target="_blank" rel="noopener noreferrer" aria-label="Instagram @tatuameoficial" className="p-2 text-muted-foreground hover:text-foreground transition-colors">
            ...
            <a href="https://tiktok.com/@tatuameoficial" target="_blank" rel="noopener noreferrer" aria-label="TikTok @tatuameoficial" className="p-2 text-muted-foreground hover:text-foreground transition-colors">
            ...
            <Button asChild size="sm" variant="outline" className="border-primary/40 text-primary hover:bg-primary/10">
              <Link to={tatuadorHref as any}><Brush className="h-4 w-4 mr-1" /> Cadastro Tatuador</Link>
            </Button>
